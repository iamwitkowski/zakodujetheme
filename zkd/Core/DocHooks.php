 ...
 * Core: DOC Hooks
 *
 * Class responsible for firing DOC Hooks.
 * @shortcode @action @filter
 *
 * 
 */
namespace zkd\Core;
...
class DocHooks extends Singleton
{
   ...
   * @var string
   */
  protected $docHooksPattern = '#\* @(?P<type>filter|action|shortcode)\s+(?P<name>[a-zA-Z0-9\-\.\/_=]+)(\s+(?P<priority>\d+))?#';
